...
export const GAMES: GameDef[] = [
  {
    ...
    categories: [
      ...
      },
      {
        key: "world-1",
        name: "World 1",
        description: "Fastest route to clear the World 1 castle.",
        timingMethod: "RTA",
        splits: s("1-1", "1-2", "1-3", "1-Tower", "1-4", "1-6", "1-Castle"),
      },
      {
        key: "world-2",
        name: "World 2",
        description: "Fastest route to clear the World 2 castle.",
        timingMethod: "RTA",
        splits: s("2-1", "2-3", "2-Tower", "2-4 (Secret Exit)", "2-Castle"),
      },
      {
        key: "world-3",
        name: "World 3",
        description: "Fastest route to clear the World 3 castle.",
        timingMethod: "RTA",
        splits: s("3-1", "3-2", "3-Tower", "3-4 (Secret Exit)", "3-5", "3-4 (Normal Exit)", "3-Castle"),
      },
      {
        key: "world-4",
        name: "World 4",
        description: "Fastest route to clear the World 4 castle.",
        timingMethod: "RTA",
        splits: s("4-1", "4-2", "4-Tower", "4-4", "4-Ghost House (Secret Exit)", "4-Castle", "4-Airship"),
      },
      {
        key: "world-5",
        name: "World 5",
        description: "Fastest route to clear the World 5 castle.",
        timingMethod: "RTA",
        splits: s("5-1", "5-3", "5-Tower", "5-4", "5-Ghost House", "5-5", "5-Castle"),
      },
      {
        key: "world-6",
        name: "World 6",
        description: "Fastest route to clear the World 6 castle.",
        timingMethod: "RTA",
        splits: s("6-1", "6-3", "6-Tower", "6-5 (Secret Exit)", "6-Castle", "6-Airship"),
      },
      {
        key: "world-7",
        name: "World 7",
        description: "Fastest route to clear the World 7 castle.",
        timingMethod: "RTA",
        splits: s("7-1", "7-2", "7-3", "7-Tower (Secret Exit)", "7-6", "7-Castle"),
      },
      {
        key: "world-8",
        name: "World 8",
        description: "Fastest route to clear the World 8 castle.",
        timingMethod: "RTA",
        splits: s("8-1", "8-2 (Secret Exit)", "8-7", "8-Airship", "8-Castle (Bowser)"),
      },
    ],
  },
  {
